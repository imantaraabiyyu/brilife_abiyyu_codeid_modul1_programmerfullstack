...
import {
  ...
  Home as HomeIcon,
  LocalHospital as ContraceptionIcon,
  Accessibility as ContraceptionUserIcon
...
export default function Navigation() {
  ...
  const menus = [
    ...
    {
      path: "/contraceptions",
      active: "contraceptions",
      icon: ContraceptionIcon,
      label: "Contraceptions"
    },
    {
      path: "/contraception-users",
      active: "contraception-users",
      icon: ContraceptionUserIcon,
      label: "ContraceptionUsers"
    }
  ];
