...
import { deleteAll, findAll } from "../../actions/province";
...
class ProvincesPage extends Component {
  ...
  onAdd = () => {
    this.props.history.push("/provinces/add");
  };
  ...
  onRowClick = (rowData) => {
    this.props.history.push(`/provinces/${rowData[0]}`);
  };
...
const mapStateToProps = (state) => ({
  ...
  error: state.Provinces.error || state.Provinces.error,
  loading: state.Provinces.loading || state.Provinces.loading,
  deleteData: state.Provinces.data,
  deleteError: state.Provinces.error
});
...
export default withStyles(styles, { withTheme: true })(
  connect(mapStateToProps, mapDispatchToProps)(ProvincesPage)
);
