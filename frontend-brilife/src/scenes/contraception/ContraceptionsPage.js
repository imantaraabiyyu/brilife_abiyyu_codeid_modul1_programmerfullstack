...
import { deleteAll, findAll } from "../../actions/contraception";
...
class ContraceptionsPage extends Component {
  ...
  onAdd = () => {
    this.props.history.push("/contraceptions/add");
  };
  ...
  onRowClick = (rowData) => {
    this.props.history.push(`/contraceptions/${rowData[0]}`);
  };
...
const mapStateToProps = (state) => ({
  data: state.Contraceptions.data,
  error: state.Contraceptions.error || state.Contraceptions.error,
  loading: state.Contraceptions.loading || state.Contraceptions.loading,
  deleteData: state.Contraceptions.data,
  deleteError: state.Contraceptions.error
});
